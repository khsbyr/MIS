      ...
      >
        <Row gutter={[40, 30]}>
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="applicantExpierence"
              label="1. Өргөдөл гаргагч нь өнгөрсөн хугацаанд санал болгож буй төсөлтэй ижил эсвэл ойролцоо төсөл хэрэгжүүлж байсан туршлагатай эсэх?"
            >
              <TextArea
                rows={4}
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="benefitsOfSimilarProjects"
              label="2. Өмнө нь хэрэгжүүлсэн ижил төстэй төсөл, хөтөлбөр нь өнөөгийн эрхэлж буй МАА-н үйл ажиллагаанд нөлөөлсөн үр дүн, ашиг шим юу байсан талаар дурдана уу?"
            >
              <TextArea
                rows={4}
                placeholder="2. Өмнө нь хэрэгжүүлсэн ижил төстэй төсөл, хөтөлбөр нь өнөөгийн эрхэлж буй МАА-н үйл ажиллагаанд нөлөөлсөн үр дүн, ашиг шим юу байсан талаар дурдана уу? "
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="expierenceWithEntrepreneurs"
              label="3. Өнгөрсөн хугацаанд ижил төстэй төслүүдэд хамтарч ажилласан мах, сүү, ноос, ноолуурын нэмүү өртгийн сүлжээнд хамтран ажилласан малчид, мах, сүүний чиглэлийн аж ахуй эрхлэгч нартай хамтарч ажилласан туршлага юу вэ?"
            >
              <TextArea
                rows={4}
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="expierenceOfApplications"
              label="4. Гарал үүсэл мөшгих тогтолцоо, ШУ-ны ололтыг ХАА-д нэвтрүүлэх үйл ажиллагаа, малын эрүүл мэнд, маркетинг зэрэгт ашигласан технологийн дэвшлийн хэрэглээний туршлагын талаар дурдана уу."
            >
              <TextArea
                rows={4}
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="recievedAssistance"
              label="5. Танай компани/байгууллага төрийн болон олон улсын байгууллага, үндэсний ТББ, хөгжлийн болон арилжааны банкууд гэх зэрэг байгууллагуудаас хүлээн авч байсан аливаа санхүүгийн болон мэргэжлийн тусламж, дэмжлэгийг дурдана уу."
            >
              <TextArea
                rows={4}
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="howCanbeMoreEfficient"
              label="6. Санал болгож буй төсөл нь Засгийн газрын бодлого, хөтөлбөрийн хүрээнд хэрхэн хамаарах болон хөгжлийн байгууллагуудаас авсан өмнөх дэмжлэгийг энэ төслийн хүрээнд хэрхэн илүү үр дүнтэй болгож, үр өгөөжийг нь нэмэгдүүлж чадах вэ?"
            >
              <TextArea
                rows={4}
          ...
          <Col xs={24} md={24} lg={12}>
            <Form.Item
              name="durationOfSimilarProject"
              label="7. Өнгөрсөн хугацаанд хэрэгжүүлсэн ижил төстэй төслийн хэрэгжсэн хугацаа"
            >
              <TextArea
                rows={4}
                placeholder="7. Өнгөрсөн хугацаанд хэрэгжүүлсэн ижил төстэй төслийн хэрэгжсэн хугацаа"
