...
function Login  () {
    ...
    return (
        ...
        <Row >
            ...
            <Col xs={24} md={24} lg={15}  style={{backgroundColor:'white', height: '93vh'}}>
                <TextWrapper>
            ...
            <Col xs={24} md={24} lg={9} style={{backgroundColor:'#F8F8F8'}}>
                ...
                <Form
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit" className="login-form-button" onClick={moveToAdmin} >
                        Нэвтрэх
                        </Button>
                        <Button type="ghost" htmlType="submit" className="register-form-button" onClick={moveToRegister}>
                        Бүртгүүлэх
                        </Button>
                    </Form.Item>
