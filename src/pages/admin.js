...
import SettingsModal from "./user/components/SettingsModal";
...
const Admin = () => {
  ...
  const menu = (
    <Menu>
      ...
      <Menu.Item key="52" icon={<FontAwesomeIcon icon={faCog} />} onClick={add}>
        Тохиргоо
      </Menu.Item>
    </Menu>
  );
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Menu.Item key="5">
                    <Link to="/composition2">{t("composition2")}</Link>
                  </Menu.Item>
                  <Menu.Item key="6">
                    <Link to="/composition3">{t("composition3")}</Link>
                  </Menu.Item>
                  <Menu.Item key="7">
                    <Link to="/composition4">{t("composition4")}</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu
                  key="sub5"
