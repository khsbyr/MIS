            ...
            <div className="button-demo">
                ...
                <div className="datatable-responsive-demo">
                    <DataTable
                        ...
                        <Column field="" header="Холбогдох утас" sortable filter filterPlaceholder="Хайх" body={contactBodyTemplate} />
                        <Column field="" header="Регистрийн дугаар" sortable filter filterPlaceholder="Хайх" body={registerNumberBodyTemplate} />
                        <Column field="" header="Хүйс" sortable filter filterPlaceholder="Хайх" body={genderBodyTemplate} />
